...
export const SORT_SETS: SortSet[] = [
  ...
  },
  {
    ...
    title: { en: 'Who Primarily Owns This? (Para Edition)', es: 'Quien es el Responsable Principal? (Edicion Para)' },
    instruction: { en: 'Teachers can do all of these. The question is: who PRIMARILY owns it?', es: 'Los maestros pueden hacer todo esto. La pregunta es: quien es el RESPONSABLE PRINCIPAL?' },
    buckets: [
      { id: 'para', label: { en: 'Para Primarily', es: 'Principalmente el Para' }, description: { en: 'This is why you are in the room', es: 'Por esto estas en el salon' }, color: '#2563EB' },
      { id: 'teacher', label: { en: 'Teacher Primarily', es: 'Principalmente el Maestro' }, description: { en: 'Teacher owns this, para may assist', es: 'El maestro es responsable, el para puede asistir' }, color: '#9333EA' },
      { id: 'shared', label: { en: 'True Partnership', es: 'Verdadera Colaboracion' }, description: { en: 'Both contribute equally', es: 'Ambos contribuyen por igual' }, color: '#E8B84B' },
    ],
    items: [
      { text: { en: 'Writing lesson plans', es: 'Escribir planes de leccion' }, correctBucket: 'teacher', explanation: { en: 'The teacher designs instruction. Paras may give input on what students need, but the plan is the teacher\'s.', es: 'El maestro disena la instruccion. Los paras pueden dar su opinion, pero el plan es del maestro.' } },
      { text: { en: 'Reinforcing a skill with a small group', es: 'Reforzar una habilidad con un grupo pequeno' }, correctBucket: 'para', explanation: { en: 'This is the primary reason paras are in the room. Teachers also do small groups, but targeted skill reinforcement is core para work.', es: 'Esta es la razon principal por la que los paras estan en el salon. El refuerzo dirigido de habilidades es trabajo central del para.' } },
      { text: { en: 'Deciding a student\'s grade', es: 'Decidir la calificacion de un estudiante' }, correctBucket: 'teacher', explanation: { en: 'Grading is always the teacher\'s responsibility, even if the para sees the student\'s work daily.', es: 'Calificar es siempre responsabilidad del maestro, incluso si el para ve el trabajo del estudiante diariamente.' } },
      { text: { en: 'Collecting data on student behavior', es: 'Recopilar datos sobre el comportamiento del estudiante' }, correctBucket: 'shared', explanation: { en: 'Both observe students daily. The para often sees things the teacher misses. The teacher interprets the data and makes decisions.', es: 'Ambos observan a los estudiantes diariamente. El para a menudo ve cosas que el maestro no. El maestro interpreta los datos y toma decisiones.' } },
      { text: { en: 'Communicating with parents about academics', es: 'Comunicarse con padres sobre temas academicos' }, correctBucket: 'teacher', explanation: { en: 'Academic communication goes through the teacher. Paras may share positive moments informally, but formal academic discussions are the teacher\'s.', es: 'La comunicacion academica pasa por el maestro. Los paras pueden compartir momentos positivos informalmente.' } },
      { text: { en: 'Helping a student with daily living skills', es: 'Ayudar a un estudiante con habilidades de la vida diaria' }, correctBucket: 'para', explanation: { en: 'Direct student support for daily needs is a primary para function. Teachers focus on instruction while paras handle personal care and functional skills.', es: 'El apoyo directo al estudiante para necesidades diarias es una funcion principal del para.' } },
      { text: { en: 'Modifying materials for a student with an IEP', es: 'Modificar materiales para un estudiante con IEP' }, correctBucket: 'shared', explanation: { en: 'The teacher decides WHAT to modify. The para often helps CREATE the modified materials. True collaboration.', es: 'El maestro decide QUE modificar. El para a menudo ayuda a CREAR los materiales modificados. Verdadera colaboracion.' } },
      { text: { en: 'Attending IEP meetings', es: 'Asistir a reuniones de IEP' }, correctBucket: 'shared', explanation: { en: 'Both perspectives matter. The para brings daily observation data that the teacher may not have. The teacher brings academic progress data.', es: 'Ambas perspectivas importan. El para trae datos de observacion diaria. El maestro trae datos de progreso academico.' } },
      { text: { en: 'Managing classroom behavior for the whole class', es: 'Manejar el comportamiento del salon completo' }, correctBucket: 'teacher', explanation: { en: 'Whole-class systems are the teacher\'s domain. Paras support individual students within that system, but the system itself belongs to the teacher.', es: 'Los sistemas de toda la clase son dominio del maestro. Los paras apoyan estudiantes individuales dentro de ese sistema.' } },
      { text: { en: 'Redirecting a student during independent work', es: 'Redirigir a un estudiante durante trabajo independiente' }, correctBucket: 'para', explanation: { en: 'In-the-moment individual support is exactly what paras do best. The teacher is often working with another group while the para circulates.', es: 'El apoyo individual en el momento es exactamente lo que los paras hacen mejor.' } },
    ],
    research: { en: 'Research on paraprofessional roles (Giangreco) shows that clearly defined responsibilities lead to better student outcomes and lower para burnout. The key insight: the question is not "can a teacher do this?" (yes, always) but "who primarily owns it in a co-teaching model?"', es: 'La investigacion sobre roles de paraprofesionales (Giangreco) muestra que responsabilidades claramente definidas llevan a mejores resultados. La pregunta clave no es "puede un maestro hacer esto?" (si, siempre) sino "quien es el responsable principal en un modelo de co-ensenanza?"' },
  },
]
