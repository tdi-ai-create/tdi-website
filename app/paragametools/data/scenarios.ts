...
export const KNOCKOUT_SCENARIOS = [
  ...
  "A student opens their Chromebook, immediately goes to Cool Math Games, and says 'I'm researching.'",
  "A student writes their name in 6 different fonts instead of starting the assignment.",
  "A student says 'I'm so cooked' when they see the math worksheet and puts their head down.",
  "A student says 'bet' when you explain the directions, but they're clearly looking at the wrong page.",
  "A student raises their hand. You walk over. They say 'never mind, I forgot.'",
];
