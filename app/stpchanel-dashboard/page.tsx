...
export default function StPeterChanelDashboard() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('spc-completed-items');
    if (saved) {
  ...
  useEffect(() => {
    localStorage.setItem('spc-completed-items', JSON.stringify(completedItems));
  }, [completedItems]);
  ...
  const overviewData = {
    ...
    timeline: {
      ...
      inProgress: [
        ...
        { label: 'Strategy implementation tracking', detail: '21% tried strategies — 2x the 10% industry average' },
      ...
      comingSoon: [
        ...
        { label: 'Virtual session — Instructional Design group', date: 'Due May 2026' },
        { label: 'Virtual session — Class Management group', date: 'Due May 2026' },
      ],
    },
      ...
      nextToUnlock: [
        {
          ...
          detail: 'Review progress + set goals for next year — due April 2026',
          owner: 'partner',
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                >
                  ...
                  <div className="text-sm font-semibold text-[#1e2749] mb-0.5">{overviewData.stats.educatorsEnrolled.label}</div>
              ...
              <div className="bg-[#E8F5F5] rounded-2xl p-1 border border-[#38618C]/15">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#38618C]/10 rounded-xl overflow-hidden">
                  {[
                    ...
                    { value: overviewData.investment.implementationRate, label: 'hub engagement', sub: overviewData.investment.implementationSublabel },
                    { value: overviewData.investment.coursesCompleted, label: 'staff engaged', sub: overviewData.investment.coursesCompletedSublabel },
                    { value: overviewData.investment.retentionStat, label: 'partners return', sub: overviewData.investment.retentionSublabel },
                  ].map((stat, i) => (
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-xs text-gray-500 w-28 flex-shrink-0">TDI Partners</span>
                      <div className="flex-1 bg-gray-100 rounded-full h-3 overflow-hidden">
                        <div className="h-full rounded-full bg-[#38618C]" style={{ width: '74%' }}></div>
                      </div>
                      <span className="text-xs font-semibold text-[#38618C] w-14 text-right">74%</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-xs text-gray-500 w-28 flex-shrink-0">St. Peter Chanel</span>
                      <div className="flex-1 bg-gray-100 rounded-full h-3 overflow-hidden">
        ...
        {activeTab === '2026-27' && (
          <div className="space-y-4">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600">Deepening Impact - 25 Teachers</p>
              <p className="text-sm text-gray-500 mt-2">Year 1 built the foundation. Year 2 deepens the partnership with in-person observations, leadership strategy sessions, and sustained coaching support.</p>
            </div>
            ...
            {/* Section 3: What's Included - Service Cards (4 cards, NO virtual coaching) */}
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <div className="grid md:grid-cols-2 gap-2">
                {[
                  ...
                  'ROI documentation for school leadership',
            ...
            {/* Section 7: Suggested 2026-27 Timeline (exec sessions + obs days only) */}
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-200">
                  ...
                  <p className="text-sm text-gray-700">25 staff actively using the Hub with targeted course pathways</p>
                </div>
                <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-200">
                  <Check className="w-5 h-5 text-emerald-600 mb-2" />
                  <p className="text-sm text-gray-700">Measurable reduction in staff stress levels</p>
                </div>
                <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-200">
                  <Check className="w-5 h-5 text-emerald-600 mb-2" />
                ...
                <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-200">
                  <Check className="w-5 h-5 text-emerald-600 mb-2" />
                  <p className="text-sm text-gray-700">Teachers report increased confidence in classroom strategies</p>
                </div>
                <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-200 md:col-span-2 lg:col-span-2">
                  <Check className="w-5 h-5 text-emerald-600 mb-2" />
                  <p className="text-sm text-gray-700">Leadership has real-time data for board presentations and accreditation</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#1e2749] rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="text-white text-center md:text-left">
                <p className="font-semibold text-lg">Ready to bring TDI on-site?</p>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-start">
                    <div>
                      <div className="font-medium text-[#1e2749]">Educational Consulting Agreement</div>
                      <div className="text-sm text-gray-500">Partnership established April 2025</div>
                    </div>
                  ...
                  <div className="text-sm text-gray-600 mt-2">
                    Includes: On-Campus Observations, Virtual Strategy Sessions, Executive Impact Sessions, Learning Hub Access
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a
                    href="mailto:Billing@Teachersdeserveit.com?subject=Billing Question - St. Peter Chanel School"
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="text-sm text-gray-600 mb-3">Teachers Deserve It</div>
                  <a
                    href="mailto:rae@teachersdeserveit.com?subject=Partnership Question - St. Peter Chanel School"
