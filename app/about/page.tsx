        ...
        <div className="container-default">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-5xl mx-auto">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-sm" style={{ color: '#ffffff', opacity: 0.9 }}>Administrators report stronger morale, greater trust,<br />and improved retention after TDI Support Sessions</p>
            </div>
            <div>
...
<div className="flex gap-4 mt-6">
  ...
  <a
    href="https://www.facebook.com/raehughart"
    target="_blank"
    rel="noopener noreferrer"
    className="w-10 h-10 rounded-full flex items-center justify-center transition-all hover:scale-110"
    style={{ backgroundColor: '#1e2749' }}
