        ...
        <div className="rounded-xl overflow-hidden shadow-lg" style={{ border: '1px solid #e5e7eb' }}>
          ...
          <div className="p-4 grid grid-cols-2 gap-3" style={{ backgroundColor: '#f5f5f5' }}>
            <div className="p-3 rounded-lg bg-white">
              <p className="text-xs font-medium mb-1" style={{ color: '#1e2749', opacity: 0.6 }}>Staff Engagement</p>
              <p className="text-sm" style={{ color: '#1e2749' }}>Who is logging in, completing courses, using resources</p>
            </div>
            <div className="p-3 rounded-lg bg-white">
              <p className="text-xs font-medium mb-1" style={{ color: '#1e2749', opacity: 0.6 }}>Implementation Progress</p>
              <p className="text-sm" style={{ color: '#1e2749' }}>Which strategies are being used in classrooms</p>
            </div>
            <div className="p-3 rounded-lg bg-white">
              <p className="text-xs font-medium mb-1" style={{ color: '#1e2749', opacity: 0.6 }}>Observation Insights</p>
              <p className="text-sm" style={{ color: '#1e2749' }}>Trends from on-campus visits, themes across classrooms</p>
            </div>
            <div className="p-3 rounded-lg bg-white">
              <p className="text-xs font-medium mb-1" style={{ color: '#1e2749', opacity: 0.6 }}>Love Notes Delivered</p>
              <p className="text-sm" style={{ color: '#1e2749' }}>Personalized feedback your teachers have received</p>
            </div>
            <div className="p-3 rounded-lg bg-white">
              <p className="text-xs font-medium mb-1" style={{ color: '#1e2749', opacity: 0.6 }}>Wellness Trends</p>
              <p className="text-sm" style={{ color: '#1e2749' }}>Staff stress and satisfaction over time</p>
            </div>
            <div className="p-3 rounded-lg bg-white">
              <p className="text-xs font-medium mb-1" style={{ color: '#1e2749', opacity: 0.6 }}>Contract Delivery</p>
        ...
        <div className="container-default">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-sm" style={{ color: '#1e2749', opacity: 0.7 }}>
                Find out which type of professional development your school needs most.
              </p>
            </Link>
