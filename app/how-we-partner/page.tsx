...
function DashboardPanel() {
  return (
    <div className="space-y-8">
      ...
      {/* Dashboard Image - Large and Centered */}
          ...
          >
            <div className="relative rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow">
              <img
                ...
                alt="TDI Leadership Dashboard Preview"
                className="w-full h-auto group-hover:scale-[1.02] transition-transform duration-300"
              />
              <div className="absolute inset-0 bg-[#1e2749]/0 group-hover:bg-[#1e2749]/5 transition-colors" />
            </div>
          </a>
      ...
      {/* What You Can Track */}
      <div>
        <h3 className="text-xl font-bold mb-4 text-center" style={{ color: '#1e2749' }}>What You Can Track</h3>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="p-4 rounded-lg bg-white shadow-sm border border-gray-100">
            <div className="flex items-center gap-2 mb-2">
              <svg className="w-5 h-5" fill="#80a4ed" viewBox="0 0 24 24">
                <path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/>
              </svg>
              <p className="font-semibold" style={{ color: '#1e2749' }}>Staff Engagement</p>
            </div>
            <p className="text-sm" style={{ color: '#1e2749', opacity: 0.7 }}>Who is logging in, completing courses, using resources</p>
          </div>
          <div className="p-4 rounded-lg bg-white shadow-sm border border-gray-100">
            <div className="flex items-center gap-2 mb-2">
              <svg className="w-5 h-5" fill="#80a4ed" viewBox="0 0 24 24">
              ...
              <p className="font-semibold" style={{ color: '#1e2749' }}>Implementation Progress</p>
            </div>
            <p className="text-sm" style={{ color: '#1e2749', opacity: 0.7 }}>Which strategies are being used in classrooms</p>
          </div>
          <div className="p-4 rounded-lg bg-white shadow-sm border border-gray-100">
            <div className="flex items-center gap-2 mb-2">
              <svg className="w-5 h-5" fill="#80a4ed" viewBox="0 0 24 24">
              ...
              <p className="font-semibold" style={{ color: '#1e2749' }}>Observation Insights</p>
            </div>
            <p className="text-sm" style={{ color: '#1e2749', opacity: 0.7 }}>Trends from on-campus visits, themes across classrooms</p>
          </div>
          <div className="p-4 rounded-lg bg-white shadow-sm border border-gray-100">
            <div className="flex items-center gap-2 mb-2">
              <svg className="w-5 h-5" fill="#80a4ed" viewBox="0 0 24 24">
              ...
              <p className="font-semibold" style={{ color: '#1e2749' }}>Love Notes Delivered</p>
            </div>
            <p className="text-sm" style={{ color: '#1e2749', opacity: 0.7 }}>Personalized feedback your teachers have received</p>
          </div>
          <div className="p-4 rounded-lg bg-white shadow-sm border border-gray-100">
            <div className="flex items-center gap-2 mb-2">
              <svg className="w-5 h-5" fill="#80a4ed" viewBox="0 0 24 24">
              ...
              <p className="font-semibold" style={{ color: '#1e2749' }}>Wellness Trends</p>
            </div>
            <p className="text-sm" style={{ color: '#1e2749', opacity: 0.7 }}>Staff stress and satisfaction over time</p>
          </div>
          <div className="p-4 rounded-lg bg-white shadow-sm border border-gray-100">
            <div className="flex items-center gap-2 mb-2">
              <svg className="w-5 h-5" fill="#80a4ed" viewBox="0 0 24 24">
              ...
              <p className="font-semibold" style={{ color: '#1e2749' }}>Contract Delivery</p>
            </div>
            <p className="text-sm" style={{ color: '#1e2749', opacity: 0.7 }}>What you purchased vs. what has been delivered</p>
          </div>
        </div>
