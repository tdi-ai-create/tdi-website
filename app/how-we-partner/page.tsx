        ...
        <div className="container-default">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-sm" style={{ color: '#1e2749', opacity: 0.7 }}>
                Estimate improvements in teacher retention, stress reduction, and student outcomes.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-sm" style={{ color: '#1e2749', opacity: 0.7 }}>
                Answer 5 questions about your school and receive a tailored plan within 24 hours.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-sm" style={{ color: '#1e2749', opacity: 0.7 }}>
                80% of our partner schools secure grants or external funding. See how.
              </p>
            </Link>
          </div>
        </div>
