            ...
            <div className="grid grid-cols-3 gap-4 items-center">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="p-4 rounded-xl text-center shadow-md cursor-pointer transition-all duration-300 hover:scale-[1.03] hover:shadow-lg" style={{ backgroundColor: '#f8f9fa' }}>
                  ...
                  <h3 className="font-bold text-xs mb-1 whitespace-nowrap" style={{ color: '#1e2749' }}>Teachers dread it.</h3>
                ...
                <div className="p-4 rounded-xl text-center shadow-md cursor-pointer transition-all duration-300 hover:scale-[1.03] hover:shadow-lg" style={{ backgroundColor: '#f8f9fa' }}>
                  ...
                  <h3 className="font-bold text-xs mb-1 whitespace-nowrap" style={{ color: '#1e2749' }}>No measurable outcomes.</h3>
                  <p className="text-xs whitespace-nowrap" style={{ color: '#1e2749', opacity: 0.7 }}>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="p-4 rounded-xl text-center shadow-md cursor-pointer transition-all duration-300 hover:scale-[1.03] hover:shadow-lg" style={{ backgroundColor: '#f8f9fa' }}>
                  ...
                  <h3 className="font-bold text-xs mb-1 whitespace-nowrap" style={{ color: '#1e2749' }}>Burnout drives turnover.</h3>
                  <p className="text-xs whitespace-nowrap" style={{ color: '#1e2749', opacity: 0.7 }}>
                ...
                <div className="p-4 rounded-xl text-center shadow-md cursor-pointer transition-all duration-300 hover:scale-[1.03] hover:shadow-lg" style={{ backgroundColor: '#f8f9fa' }}>
                  ...
                  <h3 className="font-bold text-xs mb-1 whitespace-nowrap" style={{ color: '#1e2749' }}>Wellness feels fluffy.</h3>
                  <p className="text-xs whitespace-nowrap" style={{ color: '#1e2749', opacity: 0.7 }}>
