      ...
      <section className="py-8" style={{ backgroundColor: '#f5f5f5' }}>
        <div className="container-default">
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-col md:flex-row items-center gap-6 p-6 rounded-xl" style={{ backgroundColor: '#ffffff' }}>
              {/* Rae's Photo */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-lg" style={{ color: '#1e2749' }}>If you schedule a call:</h3>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5" style={{ backgroundColor: '#ffba06' }}>
                    <svg className="w-3 h-3" fill="#1e2749" viewBox="0 0 24 24">
                      <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
                    </svg>
                  </div>
                  <span style={{ color: '#1e2749', opacity: 0.8 }}>We will talk about what is working (and not working) with your current PD</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5" style={{ backgroundColor: '#ffba06' }}>
                    <svg className="w-3 h-3" fill="#1e2749" viewBox="0 0 24 24">
                  ...
                  <span style={{ color: '#1e2749', opacity: 0.8 }}>We will discuss your goals for teacher support and retention</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5" style={{ backgroundColor: '#ffba06' }}>
                    <svg className="w-3 h-3" fill="#1e2749" viewBox="0 0 24 24">
                  ...
                  <span style={{ color: '#1e2749', opacity: 0.8 }}>You will walk away with clarity on next steps, even if TDI is not the right fit</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-lg" style={{ color: '#1e2749' }}>If you send a message:</h3>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5" style={{ backgroundColor: '#ffba06' }}>
                  ...
                  <span style={{ color: '#1e2749', opacity: 0.8 }}>We respond within 24 hours (usually much faster)</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5" style={{ backgroundColor: '#ffba06' }}>
                    <svg className="w-3 h-3" fill="#1e2749" viewBox="0 0 24 24">
                  ...
                  <span style={{ color: '#1e2749', opacity: 0.8 }}>We will follow up with next steps based on your question</span>
                </li>
              </ul>
            </div>
          </div>
