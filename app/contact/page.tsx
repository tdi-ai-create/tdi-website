        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: '#ffba06' }}>
        ...
        <div className="container-default">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            >
              ...
              <h3 className="font-bold text-lg mb-2" style={{ color: '#1e2749' }}>Read<br />Our Blog</h3>
              <p className="text-sm" style={{ color: '#1e2749', opacity: 0.7 }}>
            ...
            >
              ...
              <h3 className="font-bold text-lg mb-2" style={{ color: '#1e2749' }}>Listen to<br />Our Podcast</h3>
              <p className="text-sm" style={{ color: '#1e2749', opacity: 0.7 }}>
