        ...
        <div style={{ display: 'flex', minHeight: 'calc(100vh - 36px)' }}>
          ...
          <div style={{
            ...
            <div style={{ maxWidth: 480 }}>
              ...
              <a href="/join" target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: '#2A9D8F', fontWeight: 600, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 6 }}>
          ...
          <div style={{
            ...
            <div style={{ width: '100%', maxWidth: 420 }}>
              ...
              <p className="hub-login-mobile-link" style={{ textAlign: 'center', marginTop: 8 }}>
                <a href="/join" target="_blank" rel="noopener noreferrer" style={{ fontSize: 12, color: '#2A9D8F', fontWeight: 500, textDecoration: 'none' }}>
