...
const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    price: 5,
    period: '/mo',
    description: 'Quick wins, downloads, and access to the TDI community',
    ...
    features: [
      ...
      { text: 'Full Quick Win library', included: false },
      { text: 'Full course library', included: false },
    ],
    buttonText: 'Upgrade',
  },
  {
    ...
    price: 10,
    period: '/mo',
    description: 'The full toolkit for your classroom',
