...
export default function GetStartedPage() {
  ...
  const handleContinue = async () => {
    ...
    fetch('https://services.leadconnectorhq.com/hooks/3V0PYKAGmdo86GbTC1GC/webhook-trigger/afb49642-3913-454a-97e5-9823b40cf6c6', {
      ...
      body: JSON.stringify({
        ...
        role: ({"Teacher":"teacher","Para":"paraprofessional","Building Leader":"building leader","District Leader":"district leader"})[selectedRole] ?? selectedRole?.toLowerCase(),
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.gtag) {
        window.gtag('event', 'get_started_form_submit', { role: ({"Teacher":"teacher","Para":"paraprofessional","Building Leader":"building leader","District Leader":"district leader"})[selectedRole] ?? selectedRole?.toLowerCase(), path: isTeacherPath ? 'nomination' : 'pd-plan' });
      }
