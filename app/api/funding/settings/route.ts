...
export async function PATCH(request: NextRequest) {
  ...
  const allowed = ['slack_enabled', 'slack_webhook_url', 'slack_channel', 'verbosity', 'bella_slack_handle', 'rae_slack_handle', 'creator_webhook_url', 'sales_webhook_url', 'partner_webhook_url', 'content_approval_webhook_url', 'content_publish_webhook_url']
