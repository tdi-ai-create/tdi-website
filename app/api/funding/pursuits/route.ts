...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const fields = ['current_phase', 'funding_paths', 'school_profile', 'total_amount', 'contract_gap', 'buffer_amount', 'implementation_date', 'next_action_label', 'next_action_urgency', 'next_action_owner_email', 'internal_notes', 'submission_deadline', 'expected_decision_date', 'paths_submitted', 'paths_awarded', 'total_awarded', 'is_stalled', 'client_contact_name', 'client_contact_email', 'client_contact_phone', 'client_contact_role'];
