    ...
    return (
      <div className="min-h-screen bg-[#f5f5f5] flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-lg max-w-md w-full p-10 text-center">
          ...
          <h2 style={{ fontSize: 22, fontWeight: 600, color: '#1e2749' }}>Agreement signed</h2>
  ...
  if (alreadySigned && agreementVersion === 'v2.3' && !isDemo) {
    return (
      <div className="min-h-screen bg-[#f5f5f5] flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-lg max-w-md w-full p-10 text-center">
          <CheckCircle className="w-16 h-16 text-green-500 mx-auto mb-4" />
          <h2 style={{ fontSize: 22, fontWeight: 600, color: '#1e2749' }}>Already signed</h2>
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <main style={{ maxWidth: 640, margin: '0 auto', padding: '40px 24px 60px' }}>
        ...
        {/* Soft re-sign banner */}
        {isV1Signer && (
          <div style={{ background: '#FFFBEB', border: '1px solid #FDE68A', borderRadius: 10, padding: '14px 18px', marginBottom: 32, fontSize: 13, color: '#92400E', lineHeight: 1.6 }}>
            <strong>We&apos;ve updated your agreement.</strong> The affiliate model earns creators more, so we&apos;ve shifted to that as the sole compensation model.
            Everything you&apos;ve already earned stays paid under your old terms.
          </div>
        )}

        {/* Hero */}
        <div style={{ marginBottom: 40 }}>
          <h1 style={{ fontSize: 24, fontWeight: 500, color: '#1e2749', margin: 0, fontFamily: "'Source Serif 4', Georgia, serif" }}>
            Your creator agreement
          </h1>
          <p style={{ fontSize: 14, color: '#9CA3AF', marginTop: 6 }}>
            Read what you need. Skim the rest. Questions welcome.
          </p>
        </div>
        ...
        <div>
          {QA_BLOCKS.map((block, i) => (
            <div key={i} style={{ borderBottom: '0.5px solid #E5E7EB', paddingBottom: 24, marginBottom: 24 }}>
              <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1 }}>
                  <p style={{ fontSize: 16, fontWeight: 500, color: '#1e2749', margin: '0 0 10px 0' }}>
                    {block.question}
                  </p>
        ...
        {/* Want to talk first? */}
        <div style={{ background: '#F0F9FF', border: '1px solid #BAE6FD', borderRadius: 10, padding: '18px 20px', marginBottom: 32 }}>
          <p style={{ fontSize: 15, fontWeight: 500, color: '#1e2749', margin: '0 0 6px 0' }}>Feeling unsure? Want to talk it through?</p>
          <p style={{ fontSize: 14, color: '#6B7280', lineHeight: 1.6, margin: 0 }}>
            ...
            Email <a href="mailto:creatorstudio@teachersdeserveit.com" style={{ color: '#2563EB' }}>creatorstudio@teachersdeserveit.com</a> to set up a quick call.
          </p>
        </div>

        {/* Signature form */}
        <div style={{ background: 'white', borderRadius: 12, border: '1px solid #E5E7EB', padding: 28 }}>
          <p style={{ fontSize: 16, fontWeight: 500, color: '#1e2749', margin: '0 0 20px 0' }}>Sign your agreement</p>
...
const QA_BLOCKS = [
  {
    ...
    answer: 'You get a unique affiliate link. Anyone who signs up to TDI through it earns you <strong>50% of revenue, forever</strong>. Paid by the 15th of every month, with a clear breakdown of what was earned and what was deducted.<br/><br/>Net revenue = gross minus payment processing fees, taxes, and refunds. Never deducted: TDI overhead, platform costs, or other operating expenses.',
    legal: "Creator's sole compensation under this Agreement is a 50% share of Affiliate Revenue. \"Affiliate Revenue\" means the net revenue (gross revenue minus payment processing fees, taxes/regulatory charges, and refunds) generated by users who sign up to TDI through Creator's unique affiliate link. Revenue accrues regardless of which Creator's content the referred user ultimately purchases. Payouts are made monthly by the 15th of the following month, accompanied by a transparency statement itemizing each conversion. TDI will never deduct overhead, platform costs, or operating expenses from Creator's share.",
  },
  {
    question: 'When do I get paid?',
    answer: 'By the 15th of the month after the conversion happens. So a sale in May = paid by June 15. You\'ll get a transparency statement showing every line item.',
    legal: 'Payouts are made monthly by the 15th of the following month, accompanied by a transparency statement itemizing each conversion, gross amount, deductions, and net payout.',
  },
  {
    question: 'How long does my affiliate link last?',
    answer: 'Forever, while your TDI account is active or paused. The link doesn\'t expire. The cookie that tracks clicks lasts 90 days &mdash; so if someone clicks today and signs up 89 days later, you still earn.',
    legal: 'Affiliate tracking cookies persist for 90 days from the date of click. Creator\'s affiliate link remains active for the duration of this Agreement and during any paused period.',
  },
  {
    question: 'Who owns the stuff I make?',
    answer: 'TDI owns the final published version. This is what lets us legally distribute, market, and protect your work. You can reference your work in your portfolio, list TDI as a client, and share that you created it.<br/><br/>You also keep ownership of anything you brought with you &mdash; templates, frameworks, materials you already owned.',
    legal: "Creator assigns to TDI ownership of the final published version of Content created under this Agreement (\"Work Product\"). This assignment enables TDI to distribute, market, sublicense, and protect the Content. Creator retains ownership of all pre-existing materials, frameworks, templates, and methodologies brought to the project (\"Creator IP\"). Creator may reference the Work Product in professional portfolios, list TDI as a client, and describe the work publicly. TDI grants Creator a perpetual, non-exclusive license to reference the Work Product for personal branding purposes.",
  },
  {
    question: 'Can I quit anytime?',
    answer: 'Yes. Either of us can end this with 14 days\' notice in writing. Anything you\'ve already earned through your termination date stays paid &mdash; no clawbacks, no drama.<br/><br/>After termination, no new revenue accrues, but anything earned keeps paying out monthly until it\'s done.',
    legal: 'This Agreement is effective upon signing and continues until terminated. Either party may terminate with 14 days\' written notice. Upon termination: (a) all earned but unpaid compensation will be paid within 30 days; (b) TDI retains license to continue distributing existing Content; (c) Creator\'s affiliate link is deactivated and no new revenue accrues after the termination date.',
  },
  {
    question: 'Can I work with other education companies?',
    answer: 'Yes, absolutely. You\'re not exclusive to TDI by default. Run your own offerings, work with other clients, do your own thing. We only ask you not to recreate the exact same content for a direct TDI competitor.',
    legal: 'Default: Non-Exclusive (Option A). Creator is free to create content for other platforms, run independent businesses, and engage in any professional activities. Creator agrees not to recreate substantially the same Content for a direct competitor of TDI during the term of this Agreement. "Direct competitor" means a platform that offers paid professional development courses specifically for K-12 educators.',
  },
  {
  ...
  {
    question: 'What\'s all the FERPA stuff about?',
    answer: 'FERPA is the federal student privacy law. We ask you to not include identifiable student information (names, photos, performance data) in your content unless you have proper consent. This protects you, the students, and us. If you film in a real classroom, you just follow the school\'s rules &mdash; TDI will help coordinate.',
    legal: 'Creator shall not include personally identifiable student information (names, images, performance data, behavioral records) in Content unless proper written consent has been obtained per applicable law. If Content involves filming in educational settings, Creator will coordinate with the institution\'s administration to ensure compliance with their media/consent policies. TDI will provide guidance and support for FERPA compliance as needed.',
  },
  {
    question: 'I already signed an older agreement &mdash; what changes?',
    answer: 'The compensation model is now fully affiliate-based. Anything earned under your previous agreement stays paid under those terms. From the day you sign this version forward, the new model applies.<br/><br/>We changed it because creators told us they made more money this way. We listened.',
    legal: "Creator's prior agreement (if any) is superseded by this Agreement upon execution. Compensation earned under previous terms remains payable under those terms. All future compensation is governed by Section 2 of this Agreement.",
  },
  {
    question: 'What if there\'s a disagreement?',
    answer: 'First, we talk it out &mdash; most issues resolve in conversation. If we genuinely can\'t agree after 30 days, we\'d go to arbitration rather than court. Faster and easier for everyone.',
    legal: 'Dispute Resolution: Good faith negotiation for 30 days, then binding arbitration under AAA Commercial Rules in DuPage County, Illinois. Governing Law: Illinois.',
  },
  {
    question: 'Who do I contact with questions?',
    answer: 'Anytime, anything: <a href="mailto:creatorstudio@teachersdeserveit.com" style="color: #2563EB">creatorstudio@teachersdeserveit.com</a>. We mean it &mdash; we\'d rather answer 100 questions than have you sign something you\'re not 100% comfortable with.',
    legal: null,
  },
];
