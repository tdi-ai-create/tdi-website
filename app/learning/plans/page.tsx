...
const TIERS = [
  {
    ...
    icon: Sparkles,
    accent: '#6B7280',
    description: 'A handful of rotating tools each week.',
    features: [
  ...
  },
  {
    ...
    icon: Zap,
    accent: '#185FA5',
    description: 'More Quick Wins than your tote bag can hold.',
    features: [
      { text: 'Everything in Free', included: true },
      { text: 'More Quick Wins than your tote bag can hold', included: true },
      { text: 'PDFs and templates you will actually use', included: true },
      { text: 'Community access (your people are here)', included: true },
      { text: 'Priority email support', included: true },
      { text: 'Full course library', included: false },
    ],
    highlight: false,
    ctaLabel: 'Get Essentials',
    ctaType: 'paid' as const,
  },
  {
    id: 'professional',
    name: 'Professional',
    ...
    icon: Crown,
    accent: '#2A9D8F',
    description: 'The full Quick Win library, always growing.',
    features: [
      { text: 'Everything in Essentials', included: true },
      { text: 'The full Quick Win library, always growing', included: true },
      { text: 'Practice games that make PD feel like play', included: true },
      { text: 'First dibs on new courses', included: true },
      { text: 'Monthly content drops (like a subscription box, but useful)', included: true },
      { text: 'Full course library', included: false },
    ],
    highlight: true,
  ...
  },
  {
    ...
    icon: Crown,
    accent: '#1e2749',
    description: 'The entire course library, no limits.',
    features: [
      { text: 'Everything in Professional', included: true },
      { text: 'The entire course library, no limits', included: true },
      { text: 'PD certificates your admin will love', included: true },
      { text: 'Exclusive workshops you will not find anywhere else', included: true },
      { text: 'Direct access to our creators', included: true },
      { text: '1-on-1 coaching when you need a thought partner', included: true },
    ],
    highlight: false,
    ...
    <main style={{ backgroundColor: '#ffffff' }}>
      ...
      <section style={{ backgroundColor: '#1e2749', padding: '80px 16px 60px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 18, color: 'white', opacity: 0.85, maxWidth: 700, margin: '0 auto', lineHeight: 1.6 }}>
            Sign up today and get instant access to our current platform while we put the final touches on the new Hub. Your new Hub login is delivered the moment we launch.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '60px 16px', backgroundColor: '#F9FAFB' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
                  ...
                  {tier.ctaType === 'free' ? (
                    <a
                      ...
                      style={{
                        ...
                        background: 'white', color: tier.accent,
                        border: `1px solid ${tier.accent}`, borderRadius: 8,
                    ...
                    <button
                      ...
                      style={{
                        width: '100%', padding: '12px',
                        background: isLoading ? '#9CA3AF' : tier.accent,
                        color: 'white',
                    ...
                    >
                      {isLoading ? 'Starting checkout...' : tier.ctaLabel}
                    </button>
                  )}
                </div>
              )
          ...
          {checkoutError && (
            <p style={{ textAlign: 'center', fontSize: 14, color: '#B91C1C', maxWidth: 700, margin: '0 auto 16px' }}>
              {checkoutError}
            </p>
          )}

          <p style={{ textAlign: 'center', fontSize: 14, color: '#6B7280', maxWidth: 700, margin: '0 auto' }}>
            Bulk pricing available for schools and districts. <Link href="/for-schools" style={{ color: '#2A9D8F', fontWeight: 500 }}>Explore partnership options →</Link>
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '40px 16px', backgroundColor: 'white', borderTop: '0.5px solid #E5E7EB' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 32, maxWidth: 800, margin: '24px auto 0', alignItems: 'center' }}>
            ...
            <div>
              <p style={{ fontSize: 32, fontWeight: 700, color: '#1e2749', margin: 0 }}>74%</p>
              <p style={{ fontSize: 12, color: '#6B7280', margin: 0 }}>Classroom application rate</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* WAITLIST FORM - kept for people who want notification without paying */}
            ...
            <>
              <div style={{ textAlign: 'center', marginBottom: 32 }}>
                <p style={{ fontSize: 13, fontWeight: 600, letterSpacing: 1.5, textTransform: 'uppercase', color: '#ffba06', marginBottom: 12 }}>
                  Not ready yet? Get on the list.
                </p>
                <h2 style={{ fontSize: 32, fontWeight: 700, color: 'white', margin: '0 0 12px 0' }}>
                  We'll let you know when the new Hub is live.
                </h2>
                <p style={{ fontSize: 16, color: 'white', opacity: 0.85, lineHeight: 1.6 }}>
                  Prefer to wait until launch? Drop your info and we'll email you the moment the new Hub goes live in June 2026.
                </p>
              </div>
