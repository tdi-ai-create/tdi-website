...
// A printable reference of every automated email sent to creators.
// Access: /tdi-admin/creators/email-audit
    ...
    <div className="max-w-4xl mx-auto px-6 py-10 print:px-0 print:py-0">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Every automated email sent to creators &mdash; updated {new Date().toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}
            </p>
          </div>
          <button
      ...
      <div className="mt-12 pt-6 border-t border-gray-200 text-center">
        ...
        <p className="text-xs text-gray-400 mt-1">
          To update this document, edit <code className="text-gray-500">app/tdi-admin/creators/email-audit/page.tsx</code>
        </p>
      </div>
    </div>
  );
