    ...
    <Shell>
      ...
      <div style={S.card}>
        <div style={S.filters}>
          ...
          {/* Every line with its delivery and billing position, as a file.
              ledger is its own column so grant and client money cannot be
              summed together by accident in a spreadsheet. */}
          <a href="/api/tdi-admin/billing/export?view=contracts" style={S.dl} download>
            Export all lines
          </a>
        </div>
