...
interface CommunityNudgeProps {
  contentSlug: string
  contentType?: 'game' | 'quick_win' | 'lesson'
  onDismiss?: () => void
}
...
export default function CommunityNudge({ contentSlug, contentType = 'quick_win', onDismiss }: CommunityNudgeProps) {
  ...
  const communityUrl = contentType === 'lesson'
    ? '#community'
    : `/hub/quick-wins/${contentSlug}#community`
