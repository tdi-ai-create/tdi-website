/**
 * Shared HTML email builder for Olivia's briefing reports.
 * Used by both daily and weekly briefing crons.
 */

export function buildHtmlEmail(markdown: string, subject: string): string {
  let html = markdown;
