-- Nothing empty gets past drafting.
--
-- The endpoint has enforced this since the production deploy on 9 September
-- (PR #424, verified live before this migration ran). This adds the same
-- guarantee at the table, so it holds for any caller.
--
-- Replaces content_queue_gate() from migration 139, preserving rules 1 to 6
-- exactly and prepending rule 0. The trigger itself is unchanged and is not
-- redefined here.
